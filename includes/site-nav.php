...
<header class="navbar">
    <div class="logo">
        <a href="index.php"><img src="images/logo-.png" alt="Pastry Haven Logo"></a>
    </div>
    <nav>
        ...
        <a href="index.php#how-to-order" class="<?php echo $active_nav === 'order' ? 'active' : ''; ?>">HOW TO ORDER</a>
        <a href="index.php#about" class="<?php echo $active_nav === 'about' ? 'active' : ''; ?>">ABOUT US</a>
    ...
    <div class="icons-container">
        ...
        <a href="account.php" class="icon-link" aria-label="<?php echo current_user() ? 'Account' : 'Log in'; ?>"><i class="fas fa-user"></i></a>
    </div>
</header>
